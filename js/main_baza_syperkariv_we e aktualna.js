...
, {
	"brand": "",
	"models": [
	{"model": "", "productionYear": "", "engine": "", "horsepower": ""}
	]
}
, {
	"brand": "",
...
$(document).ready(function(){
	...
	$("[href=#listcars]").on('click', function(){
		...
		// var content;
		// for(var l=0; l<data.length; l++){
		// 	content += "<tr id='"+l+"'><td>"+data[l].brand+"</td><td>"+data[l].model+"</td><td class='hidden-xs'>"+data[l].productionYear+"</td><td class='visible-md visible-lg'>"+data[l].horsepower+"</td><td class='visible-lg'>"+data[l].engine+"</td></tr>";
		// }
		// $("#table").html(content);
